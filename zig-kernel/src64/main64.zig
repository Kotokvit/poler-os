...
//   v0.5.1: VirtualBox compatibility, 64-bit Long Mode fix, version bump
//   v0.6.0: APIC timer fix (vector 48), own GDT+TSS, PMM/VMM/Heap, scheduler
//
// Черновик: Linux arch/x86/kernel/setup.c (400+ строк)
// Чистовик: POLER (этот файл, ~200 строк)
// ============================================================================
...
// Черновик: Linux arch/x86/kernel/cpu/intel.c + common.c
// ============================================================================
...
// ============================================================================
// Memory Map
// Черновик: Linux arch/x86/kernel/e820.c (e820 memory map parsing)
// Multiboot2 передаёт memory map через теги
// ============================================================================
