...
//
// Черновики (Linux):
//   arch/x86/include/asm/desc_defs.h     → GDT/IDT структуры (198 строк)
//   arch/x86/include/asm/apicdef.h        → APIC регистры (177 строк)
//   arch/x86/include/asm/segment.h        → Segment selectors (370 строк)
//   arch/x86/include/asm/msr-index.h      → MSR константы (1321 строк)
//   arch/x86/include/asm/pgtable_types.h  → Page table flags (582 строк)
//
// Чистовик (POLER):
//   Всё в одном файле, только то что нужно, ~600 строк
//   Без 30 лет легаси, без CONFIG_*, без #ifdef
//
// ISR stubs: isr64.S (assembly) → isr_common_handler() (этот файл)
// ============================================================================

// NOTE: No std import — freestanding kernel, no OS support
...
// ============================================================================
// MSR Constants
// Черновик: Linux asm/msr-index.h (1321 строк) → POLER: только нужные
// ============================================================================
...
// Черновик: Linux asm/desc_defs.h + asm/segment.h → POLER: 5 записей
// ============================================================================
...
// Черновик: Linux arch/x86/kernel/idt.c (364 строки + macros)
// Чистовик: POLER — прямое заполнение через isr_stub_table из isr64.S
// ============================================================================
...
// Черновик: Linux arch/x86/kernel/i8259.c
// ============================================================================
...
// ============================================================================
// Local APIC
// Черновик: Linux asm/apicdef.h (177 строк констант) + apic.c
// ============================================================================
...
// ============================================================================
// Page Table Flags
// Черновик: Linux asm/pgtable_types.h (582 строк) → POLER: только нужные
// ============================================================================
...
// Черновик: Linux asm/processor.h → tss_struct
// ============================================================================
